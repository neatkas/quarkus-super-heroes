...
class VillainResourceTest {
    ...
    private static final String PATH = "/api/villains";
    ...
    void shouldNotAddInvalidItem() {
        ...
        given().body(villain).header(CONTENT_TYPE, JSON).header(ACCEPT,JSON)
            .when().post(PATH)
    ...
    void shouldGetInitialItems() {
        LOG.info("test shouldGetInitialItems");
        List<Villain> villains = get(PATH)
            .then()
            .statusCode(OK.getStatusCode())
            .contentType(APPLICATION_JSON)
            .extract()
    ...
    void testUpdatingAnItem() {
        LOG.info("test testUpdatingAnItem");
        LOG.info("villainId = " + villainId);
        Villain villain = new Villain();
